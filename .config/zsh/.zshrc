...
### RIGHT PROMPT
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(host vi_mode status)
POWERLEVEL9K_CONTEXT_RIGHT_PROMPT="``"
# POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(host vi_mode ssh status)
POWERLEVEL9K_HOST_BACKGROUND="236" #Grey
POWERLEVEL9K_HOST_FOREGROUND="183" #Plum3
POWERLEVEL9K_SSH_FOREGROUND="000" #Black
POWERLEVEL9K_SSH_BACKGROUND="183" #Plum3
